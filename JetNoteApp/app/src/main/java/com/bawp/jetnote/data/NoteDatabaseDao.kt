...
interface NoteDatabaseDao {
  ...
  @Query("SELECT * from notes_tbl") fun getNotes(): Flow<List<Note>>

  @Query("SELECT * from notes_tbl where id =:id") suspend fun getNoteById(id: String): Note
  ...
  @Query("DELETE from notes_tbl") suspend fun deleteAll()
